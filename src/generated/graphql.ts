...
export type BulkCreateInstanceInput = {
  createdAt?: Maybe<Scalars['DateTime']>
  defaults?: Maybe<InstanceDefaultsInput>
...
export type Mutation = {
  ...
  instance?: Maybe<InstanceMutations>
...
export type Instance = {
  __typename?: 'Instance'
  authenticationMethod?: Maybe<InstanceAuthenticationMethod>
  ...
  updatedAt?: Maybe<Scalars['DateTime']>
  users?: Maybe<Array<UserInstanceRole>>
  vatTypes?: Maybe<Array<VatType>>
  webhooks?: Maybe<Array<Webhook>>
}

export type InstanceGridsArgs = {
  language: Scalars['String']
  versionLabel?: VersionLabel
}

export type InstanceMetaPropertyArgs = {
  key: Scalars['String']
}

export type InstanceTopicsArgs = {
  language: Scalars['String']
}

export type InstanceTreeArgs = {
  versionLabel?: Maybe<VersionLabel>
}
...
export type InstanceAuthenticationMethod = {
  __typename?: 'InstanceAuthenticationMethod'
  catalog?: Maybe<AuthenticationMethod>
  search?: Maybe<AuthenticationMethod>
}

export type InstanceAuthenticationMethodInput = {
  catalog?: Maybe<AuthenticationMethod>
  search?: Maybe<AuthenticationMethod>
}

export type InstanceDefaults = {
  __typename?: 'InstanceDefaults'
  currency: Scalars['String']
  language: Scalars['String']
}

export type InstanceDefaultsInput = {
  currency?: Maybe<Scalars['String']>
  language?: Maybe<Scalars['String']>
}
...
export type InstanceMutations = {
  __typename?: 'InstanceMutations'
  addUsers: Array<UserInstanceRole>
  create: Instance
  delete: Scalars['Int']
  regenerateStaticAuthToken: Instance
  removeUsers?: Maybe<Array<UserInstanceRole>>
  setAuthenticationMethod: Instance
  update: Instance
}

export type InstanceMutationsAddUsersArgs = {
  roles: Array<UserRoleInput>
  instanceId: Scalars['ID']
}

export type InstanceMutationsCreateArgs = {
  input: CreateInstanceInput
}

export type InstanceMutationsDeleteArgs = {
  id: Scalars['ID']
}

export type InstanceMutationsRegenerateStaticAuthTokenArgs = {
  instanceId: Scalars['ID']
}

export type InstanceMutationsRemoveUsersArgs = {
  instanceId: Scalars['ID']
  userIds: Array<Scalars['ID']>
}

export type InstanceMutationsSetAuthenticationMethodArgs = {
  input?: Maybe<InstanceAuthenticationMethodInput>
  instanceId: Scalars['ID']
}

export type InstanceMutationsUpdateArgs = {
  id: Scalars['ID']
  input: UpdateInstanceInput
}

export type InstanceQueries = {
  __typename?: 'InstanceQueries'
  get?: Maybe<Instance>
  getMany?: Maybe<Array<Instance>>
  getRootTopics?: Maybe<Array<Maybe<Topic>>>
  suggestIdentifier: IdentifierSuggestion
}

export type InstanceQueriesGetArgs = {
  id?: Maybe<Scalars['ID']>
  identifier?: Maybe<Scalars['String']>
}

export type InstanceQueriesGetManyArgs = {
  identifier?: Maybe<Scalars['String']>
}

export type InstanceQueriesGetRootTopicsArgs = {
  language: Scalars['String']
  instanceId: Scalars['ID']
}

export type InstanceQueriesSuggestIdentifierArgs = {
  desired: Scalars['String']
}

export type InstanceReports = {
  __typename?: 'InstanceReports'
  orders: OrdersReport
  sales: SalesReport
}

export type InstanceReportsOrdersArgs = {
  currency: Scalars['String']
  end?: Maybe<Scalars['DateTime']>
  start?: Maybe<Scalars['DateTime']>
  instanceId: Scalars['ID']
...
export type InstanceReportsSalesArgs = {
  currency: Scalars['String']
  end?: Maybe<Scalars['DateTime']>
  start?: Maybe<Scalars['DateTime']>
  instanceId: Scalars['ID']
...
export type User = {
  ...
  marketingEmailConsentedAt?: Maybe<Scalars['DateTime']>
  role?: Maybe<UserInstanceRole>
  sub: Array<Scalars['String']>
  instances?: Maybe<Array<UserInstanceRole>>
  tocReadAt?: Maybe<Scalars['DateTime']>
}
...
export type UserMutations = {
  ...
  addInstances: Array<UserInstanceRole>
  create: User
  delete: Scalars['Int']
  generateAccessToken: AccessToken
  grantAdminRights: User
  removeInstances?: Maybe<Array<UserInstanceRole>>
  revokeAdminRights: User
  update: User
}

export type UserMutationsAddInstancesArgs = {
  roles: Array<InstanceRoleInput>
  userId: Scalars['ID']
}
...
export type UserMutationsRemoveInstancesArgs = {
...
export type ResolversTypes = {
  ...
  BulkCreateInstanceInput: BulkCreateInstanceInput
  ...
  InstanceAuthenticationMethod: ResolverTypeWrapper<InstanceAuthenticationMethod>
  InstanceAuthenticationMethodInput: InstanceAuthenticationMethodInput
  InstanceDefaults: ResolverTypeWrapper<InstanceDefaults>
  InstanceDefaultsInput: InstanceDefaultsInput
  InstanceMetrics: ResolverTypeWrapper<InstanceMetrics>
  InstanceMutations: ResolverTypeWrapper<InstanceMutations>
  InstanceQueries: ResolverTypeWrapper<InstanceQueries>
  InstanceReports: ResolverTypeWrapper<InstanceReports>
  InstanceRoleInput: InstanceRoleInput
  TierType: TierType
  ...
  UserRoles: UserRoles
  UserInstanceRole: ResolverTypeWrapper<UserInstanceRole>
...
export type ResolversParentTypes = {
  ...
  TaxInput: TaxInput
  Instance: Instance
  InstanceAuthenticationMethod: InstanceAuthenticationMethod
  InstanceAuthenticationMethodInput: InstanceAuthenticationMethodInput
  InstanceDefaults: InstanceDefaults
  InstanceDefaultsInput: InstanceDefaultsInput
  InstanceMetrics: InstanceMetrics
  InstanceMutations: InstanceMutations
  ...
  UserRoleInput: UserRoleInput
  UserInstanceRole: UserInstanceRole
  VatType: VatType
...
> = {
  orders?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<CurrencySummaryReportOrdersArgs, 'instanceId'>
  >
  sales?: Resolver<
    Array<Maybe<ResolversTypes['CurrencySummary']>>,
    ParentType,
    ContextType,
    RequireFields<CurrencySummaryReportSalesArgs, 'instanceId'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  ...
  delete?: Resolver<
    ...
    RequireFields<
      ...
      'deleteSubscriptionContracts' | 'identifier' | 'instanceId'
    >
  >
  deleteAddress?: Resolver<
    ...
    RequireFields<
      ...
      'addressId' | 'identifier' | 'instanceId'
    >
  >
  update?: Resolver<
    ResolversTypes['Customer'],
  ...
  updateAddress?: Resolver<
    ...
    RequireFields<
      ...
      'addressId' | 'identifier' | 'input' | 'instanceId'
    >
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  get?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<CustomerQueriesGetArgs, 'instanceId'>
  >
  getMany?: Resolver<
    Maybe<ResolversTypes['CustomerConnection']>,
    ParentType,
    ContextType,
    RequireFields<CustomerQueriesGetManyArgs, 'first' | 'instanceId'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  generatePresignedRequest?: Resolver<
    ...
    RequireFields<
      ...
      'contentType' | 'filename' | 'instanceId' | 'type'
    >
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  create?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<InviteTokenMutationsCreateArgs, 'instanceId'>
  >
  redeem?: Resolver<
    ResolversTypes['InviteToken'],
    ParentType,
...
> = {
  add?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<LanguageMutationsAddArgs, 'input' | 'instanceId'>
  >
  remove?: Resolver<
    Maybe<Array<ResolversTypes['Language']>>,
    ParentType,
    ContextType,
    RequireFields<LanguageMutationsRemoveArgs, 'code' | 'instanceId'>
  >
  update?: Resolver<
    Maybe<Array<ResolversTypes['Language']>>,
    ParentType,
    ContextType,
    RequireFields<LanguageMutationsUpdateArgs, 'code' | 'input' | 'instanceId'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  ...
  >
  instance?: Resolver<
    Maybe<ResolversTypes['InstanceMutations']>,
    ParentType,
    ContextType
  >
  topic?: Resolver<
...
> = {
  ...
  getMany?: Resolver<
    ...
    RequireFields<
      ...
      'first' | 'sort' | 'sortField' | 'instanceId'
    >
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  ...
  delete?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<PriceVariantMutationsDeleteArgs, 'identifier' | 'instanceId'>
  >
  update?: Resolver<
    ResolversTypes['PriceVariant'],
    ParentType,
...
> = {
  get?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<PriceVariantQueriesGetArgs, 'identifier' | 'instanceId'>
  >
  getMany?: Resolver<
    Maybe<Array<ResolversTypes['PriceVariant']>>,
    ParentType,
    ContextType,
    RequireFields<PriceVariantQueriesGetManyArgs, 'instanceId'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  ...
  >
  report?: Resolver<
    Maybe<ResolversTypes['InstanceReports']>,
    ParentType,
    ContextType
  >
  search?: Resolver<
  ...
  subscriptionPlan?: Resolver<
    ...
    ContextType
  >
  instance?: Resolver<ResolversTypes['InstanceQueries'], ParentType, ContextType>
...
> = {
  suggest?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<SearchQueriesSuggestArgs, 'language' | 'instanceId'>
  >
  topics?: Resolver<
    Maybe<ResolversTypes['TopicSearchConnection']>,
    ParentType,
    ContextType,
    RequireFields<SearchQueriesTopicsArgs, 'language' | 'instanceId'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  ...
  getMany?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<ShapeQueriesGetManyArgs, 'instanceId'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  ...
  delete?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<StockLocationMutationsDeleteArgs, 'identifier' | 'instanceId'>
  >
  update?: Resolver<
    ResolversTypes['StockLocation'],
    ParentType,
...
> = {
  get?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<StockLocationQueriesGetArgs, 'identifier' | 'instanceId'>
  >
  getMany?: Resolver<
    Maybe<Array<ResolversTypes['StockLocation']>>,
    ParentType,
    ContextType,
    RequireFields<StockLocationQueriesGetManyArgs, 'instanceId'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  getMany?: Resolver<
    ...
    RequireFields<
      ...
      'first' | 'sort' | 'subscriptionContractId' | 'instanceId'
    >
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  get?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<SubscriptionPlanQueriesGetArgs, 'identifier' | 'instanceId'>
  >
  getMany?: Resolver<
    Maybe<Array<ResolversTypes['SubscriptionPlan']>>,
    ParentType,
    ContextType,
    RequireFields<SubscriptionPlanQueriesGetManyArgs, 'instanceId'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  authenticationMethod?: Resolver<
    Maybe<ResolversTypes['InstanceAuthenticationMethod']>,
    ParentType,
    ContextType
  >
  ...
  >
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  defaults?: Resolver<ResolversTypes['InstanceDefaults'], ParentType, ContextType>
  grids?: Resolver<
    Maybe<Array<ResolversTypes['Grid']>>,
    ParentType,
    ContextType,
    RequireFields<InstanceGridsArgs, 'language' | 'versionLabel'>
  >
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  identifier?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  ...
  metaProperty?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<InstanceMetaPropertyArgs, 'key'>
  >
  metrics?: Resolver<
    Maybe<ResolversTypes['InstanceMetrics']>,
    ParentType,
    ContextType
  >
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  ...
  topics?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<InstanceTopicsArgs, 'language'>
  >
  tree?: Resolver<
    Maybe<Array<ResolversTypes['TreeNode']>>,
    ParentType,
    ContextType,
    RequireFields<InstanceTreeArgs, never>
  >
  updatedAt?: Resolver<
    Maybe<ResolversTypes['DateTime']>,
    ParentType,
  ...
  >
  users?: Resolver<
    Maybe<Array<ResolversTypes['UserInstanceRole']>>,
    ParentType,
    ContextType
  >
  vatTypes?: Resolver<
  ...
  webhooks?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<InstanceWebhooksArgs, never>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}

export type InstanceAuthenticationMethodResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['InstanceAuthenticationMethod'] = ResolversParentTypes['InstanceAuthenticationMethod']
> = {
  catalog?: Resolver<
...
export type InstanceDefaultsResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['InstanceDefaults'] = ResolversParentTypes['InstanceDefaults']
> = {
  currency?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  language?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
...
export type InstanceMetricsResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['InstanceMetrics'] = ResolversParentTypes['InstanceMetrics']
> = {
...
export type InstanceMutationsResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['InstanceMutations'] = ResolversParentTypes['InstanceMutations']
> = {
  addUsers?: Resolver<
    Array<ResolversTypes['UserInstanceRole']>,
    ParentType,
    ContextType,
    RequireFields<InstanceMutationsAddUsersArgs, 'roles' | 'instanceId'>
  >
  create?: Resolver<
    ResolversTypes['Instance'],
    ParentType,
    ContextType,
    RequireFields<InstanceMutationsCreateArgs, 'input'>
  >
  delete?: Resolver<
    ResolversTypes['Int'],
    ParentType,
    ContextType,
    RequireFields<InstanceMutationsDeleteArgs, 'id'>
  >
  regenerateStaticAuthToken?: Resolver<
    ResolversTypes['Instance'],
    ParentType,
    ContextType,
    RequireFields<InstanceMutationsRegenerateStaticAuthTokenArgs, 'instanceId'>
  >
  removeUsers?: Resolver<
    Maybe<Array<ResolversTypes['UserInstanceRole']>>,
    ParentType,
    ContextType,
    RequireFields<InstanceMutationsRemoveUsersArgs, 'instanceId' | 'userIds'>
  >
  setAuthenticationMethod?: Resolver<
    ResolversTypes['Instance'],
    ParentType,
    ContextType,
    RequireFields<InstanceMutationsSetAuthenticationMethodArgs, 'instanceId'>
  >
  update?: Resolver<
    ResolversTypes['Instance'],
    ParentType,
    ContextType,
    RequireFields<InstanceMutationsUpdateArgs, 'id' | 'input'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}

export type InstanceQueriesResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['InstanceQueries'] = ResolversParentTypes['InstanceQueries']
> = {
  get?: Resolver<
    Maybe<ResolversTypes['Instance']>,
    ParentType,
    ContextType,
    RequireFields<InstanceQueriesGetArgs, never>
  >
  getMany?: Resolver<
    Maybe<Array<ResolversTypes['Instance']>>,
    ParentType,
    ContextType,
    RequireFields<InstanceQueriesGetManyArgs, never>
  >
  getRootTopics?: Resolver<
    Maybe<Array<Maybe<ResolversTypes['Topic']>>>,
    ParentType,
    ContextType,
    RequireFields<InstanceQueriesGetRootTopicsArgs, 'language' | 'instanceId'>
  >
  suggestIdentifier?: Resolver<
    ResolversTypes['IdentifierSuggestion'],
    ParentType,
    ContextType,
    RequireFields<InstanceQueriesSuggestIdentifierArgs, 'desired'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}

export type InstanceReportsResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['InstanceReports'] = ResolversParentTypes['InstanceReports']
> = {
  orders?: Resolver<
    ResolversTypes['OrdersReport'],
    ParentType,
    ContextType,
    RequireFields<InstanceReportsOrdersArgs, 'currency' | 'instanceId'>
  >
  sales?: Resolver<
    ResolversTypes['SalesReport'],
    ParentType,
    ContextType,
    RequireFields<InstanceReportsSalesArgs, 'currency' | 'instanceId'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  ...
  getRootTopics?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<TopicQueriesGetRootTopicsArgs, 'language' | 'instanceId'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  ...
  >
  role?: Resolver<
    Maybe<ResolversTypes['UserInstanceRole']>,
    ParentType,
    ContextType,
    RequireFields<UserRoleArgs, 'instanceId'>
  >
...
> = {
  addInstances?: Resolver<
    Array<ResolversTypes['UserInstanceRole']>,
    ParentType,
    ContextType,
    RequireFields<UserMutationsAddInstancesArgs, 'roles' | 'userId'>
  >
  create?: Resolver<
    ResolversTypes['User'],
    ParentType,
  ...
  >
  removeInstances?: Resolver<
    Maybe<Array<ResolversTypes['UserInstanceRole']>>,
    ParentType,
    ContextType,
    RequireFields<UserMutationsRemoveInstancesArgs, 'instanceIds' | 'userId'>
  >
...
export type UserInstanceRoleResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['UserInstanceRole'] = ResolversParentTypes['UserInstanceRole']
> = {
...
> = {
  ...
  getMany?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<WebhookQueriesGetManyArgs, 'instanceId'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
export type Resolvers<ContextType = any> = {
  ...
  InstanceAuthenticationMethod?: InstanceAuthenticationMethodResolvers<ContextType>
  InstanceDefaults?: InstanceDefaultsResolvers<ContextType>
  InstanceMetrics?: InstanceMetricsResolvers<ContextType>
  InstanceMutations?: InstanceMutationsResolvers<ContextType>
  InstanceQueries?: InstanceQueriesResolvers<ContextType>
  InstanceReports?: InstanceReportsResolvers<ContextType>
  ...
  UserInstanceRole?: UserInstanceRoleResolvers<ContextType>

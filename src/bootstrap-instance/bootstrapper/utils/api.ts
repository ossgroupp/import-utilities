  ...
  async work() {
    ...
    try {
      ...
      response = await request(
        ...
        {
          'X-OSSPIM-Access-Token-Id': this.OSSPIM_ACCESS_TOKEN_ID,
          'X-OSSPIM-Access-Token-Secret': this
            .OSSPIM_ACCESS_TOKEN_SECRET,
          'X-OSSPIM-Static-Auth-Token': this.OSSPIM_STATIC_AUTH_TOKEN,
        }
      )
      if (this.logLevel === 'verbose') {
